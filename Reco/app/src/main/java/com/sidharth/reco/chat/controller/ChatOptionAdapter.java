...
public class ChatOptionAdapter extends RecyclerView.Adapter<ChatOptionHolder> {
    ...
    public ChatOptionAdapter(Context context, ChatOptionModel optionModel, OnChatOptionClickListener onChatOptionClickListener) {
    ...
    public void onBindViewHolder(@NonNull ChatOptionHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(view -> onChatOptionClickListener.onOptionClicked(optionModel, position));
    }
